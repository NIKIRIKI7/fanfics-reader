...
export const works: Work[] = [
    ...
    soundtracks: [
      {
        ...
        title: 'Memory Lane',
        tracks: [
          { id: 't1', title: 'Space Ambience', artist: 'Void', url: 'https://cdn.pixabay.com/download/audio/2022/03/24/audio_1420790680.mp3' },
          { id: 't2', title: 'Melancholy', artist: 'Piano', url: 'https://cdn.pixabay.com/download/audio/2022/05/27/audio_1808fbf07a.mp3' }
        ]
      },
      {
        id: '2',
        ...
        tracks: [
          { id: 't3', title: 'Deep Drone', artist: 'Signal', url: 'https://cdn.pixabay.com/download/audio/2023/02/28/audio_550d815fa5.mp3' }
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    summary: 'Distance is relative. A space-opera adaptation where the idol industry spans galaxies.',
    tags: ['SpaceOpera', 'Romance'],
    coverUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAmYNhe1btI_4LjruIicKqJS45MOjTQBMWvfOViUfcmoJXDHoMf-hUpPp9YtbOlIFc5bMfloJtmlldYGisiRHW4jtYGdLx2IkZMPELUVJd1aOLrnni6JQgwfHwBBU1tOjVw0r7zgmlLWKKBnZgYYQx3zCLrydPLbI9R4KNSeXfppH96a1sQLg7WiVtzAbKEtIKGyh7FOiDaR1zbIPeQcfRDf7cNQNqR7wNc31hUsXBp1inAAnpp1ULlCCEXdPSBnw-LKlCa9cvgbGo',
