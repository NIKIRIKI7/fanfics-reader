  ...
  <Teleport to="body">
    <transition :css="false" @enter="onEnterFade" @leave="onLeaveFade">
      <div v-if="isOpen" class="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        <div
          class="relative bg-background-primary border border-border rounded-xl shadow-2xl max-w-md w-full overflow-hidden flex flex-col"
        >
          <div class="flex items-center justify-between p-4 border-b border-border">
            <span class="text-sm font-bold uppercase tracking-widest text-text-secondary"
              >Share Transmission</span
            >
            <button
              @click="$emit('close')"
            ...
            >
              <div class="flex justify-between items-start relative z-10">
                <div class="flex flex-col">
                  <span class="text-accent text-[10px] font-bold uppercase tracking-[0.2em] mb-1"
                    >Project: Grey Sky</span
                  >
              ...
              <div class="flex flex-col gap-2 relative z-10">
                <h3
                  class="text-3xl font-display font-black italic text-text-primary leading-tight"
                  style="color: #ffffff"
                >
                  {{ work.title }}
                </h3>
              ...
              <p
                class="text-text-secondary text-sm font-display italic leading-relaxed relative z-10"
                style="color: #a3a3a3"
              >
                "{{ work.summary }}"
              </p>
              <div
                class="pt-4 border-t border-border flex justify-between items-center text-[10px] text-text-muted font-sans uppercase tracking-wider relative z-10"
                style="border-color: #262626; color: #525252"
              >
